...
select distinct p.protocol_id from protocols p left outer join [dbo].[ProtocolCalendarStatusHistory] ch on p.protocol_id = ch.protocol_id
where ch.protocol_id is null
