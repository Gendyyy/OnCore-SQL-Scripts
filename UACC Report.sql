...
FROM ONCOREPROD..UACC_ONCORE_RW_UTILS.MYPSV2 S
    ...
    AND ON_STUDYDATE BETWEEN '01-JAN-2023' AND '31-DEC-2023'
...
-- S.CURRENT_STATUS SUBJECT_CURRENT_STATUS,
-- S.STUDY_STATUS SUBJECT_STUDY_STATUS,
-- UACC_ONCORE_RW_UTILS.GET_SUBJECT_STAFF_NAMES_RO(P.PROTOCOL_ID,PROTOCOL_SUBJECT_ID,''Consenting Physician'') CONSENTING_PHYS,
-- UACC_ONCORE_RW_UTILS.GET_SUBJECT_STAFF_NAMES_RO(P.PROTOCOL_ID,PROTOCOL_SUBJECT_ID,''Treating Physician'') TREATING_PHYS,
-- P.NCT_ID,
-- P.NCI_CTRP_ID,
-- P.TREATMENT_TYPE_DESC,
-- P.SUMMARY4_REPORT_TYPE,
